...
parser.add_argument('--img_size', type=int, default=224, help='input patch size of network input') # 224
...
if __name__ == "__main__":
    ...
    args.exp = 'MCAFTM_Cascaded_Small_loss_MUTATION_w3_7_' + dataset_name + str(args.img_size)
    snapshot_path = "model_MCAFTM_Synapse_NoSB/{}/{}".format(args.exp, 'MCAFTM_Cascaded_Small_loss_MUTATION_w3_7')
    ...
    print(snapshot,'current load path -------------->>>>>>>>>>>>>')
