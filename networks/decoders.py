...
from DW import FETBlock, Attention
...
class MCAFTM(nn.Module):
    def __init__(self, channels=[512, 320, 128, 64], kernel_sizes=[1, 3, 5], expansion_factor=6, dw_parallel=True,
        ...
        self.Aggregator1 = Aggregator(channels[0])
        self.Aggregator2 = Aggregator(channels[1])
        self.Aggregator3 = Aggregator(channels[2])
        self.Aggregator4 = Aggregator(channels[3])
        ...
        self.wave3 = FETBlock(320,10,1)
        self.wave2 = FETBlock(128,4,1)
        self.wave1 = FETBlock(64, 2,1)
        # self.Dw = FETBlock(64,num_heads=8,sr_ratio=1)
