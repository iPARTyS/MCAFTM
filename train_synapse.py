...
if __name__ == "__main__":
    ...
    args.exp = 'MCAFTM_loss_MUTATION_w3_7_' + dataset_name + str(args.img_size)
    snapshot_path = "model_MCAFTM_Synapse_Loss_Agg/{}/{}".format(args.exp, 'MCAFTM_loss_MUTATION_w3_7')
    ...
    print('Model %s created, param count: %d' %
          ('MCAFTM ', sum([m.numel() for m in net.parameters()])))
