...
def inference(args, model, testloader, test_save_path=None):
    ...
    with torch.no_grad():
        ...
        logging.info('Testing performance in best val model: mean_dice : %f mean_hd95 : %f, mean_jacard : %f mean_asd : %f' %
...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_path", default="./model_ACDC_pth")
    ...
    args.exp = 'ACDC_MCAFTM_Small_loss_MUTATION_w3_7' + str(args.img_size)
    snapshot_path = "{}/{}/{}".format(args.save_path, args.exp, 'ACDC_MCAFTM_Small_loss_MUTATION_w3_7')
    ...
    print('current load_path ------->>>>>>>>>>>>>>>>>>>',snapshot)
    ...
    results = inference(args, net, testloader, test_save_path).cuda()
